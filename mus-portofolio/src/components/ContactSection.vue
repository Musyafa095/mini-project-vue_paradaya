<template>
    <section class="text-white mt-20">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be] font-roboto ">Need a web developer or designer? Drop me a line using the form below or contact me directly via email or LinkedIn. I’ll get back to you as soon as possible.
                </p>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <p>
                            <a href="https://www.linkedin.com/in/musyafa-nusia-mulya-580561322">www.linkedin.com
                            </a>
                        </p>
                        </div>
                    </div>
            ...
            <form class="flex flex-col p-2" data-aos="zoom-in-up" >
                ...
                <button class="w-full px-6 md:px-7 py-3 rounded-full sm:w-max flex justify-center text-white bg-primary border-2 border-transparent">
                    Send Message
                </button>
            </form>
        </div>
